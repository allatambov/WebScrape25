...
def get_info(item):
    ...
    price_block = item.find("div", class_ = "price_item_block")
    try:
        price = price_block.find("span", class_ ="price_item_new").text
    except:
        price = price_block.find("span", 
                                 class_ ="price_item_new price_item_with_discount").text
